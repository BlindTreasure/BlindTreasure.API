...
namespace BlindTreasure.Application.Utils
{
    public static class ErrorMessages
    {
        ...
        public const string AccountTooManyRecoveryAttempts = "Too many failed recovery attempts. Please try again after {0}.";
        ...
        public const string AccountEmailAlreadyRegistered_NoneVerified = "Email is already registered. Unverified accounts expire after 24 hours.";
        public const string Account_CityNotSupported = "City is not supported. Currently APIHub just support Ho Chi Minh, Binh Duong and Ha Noi";
        public const string AccountProfileIncomplete = "Profile is incomplete and you cannot submit api. Please complete your profile first.";
        ...
        public const string Transacion_RevewActiveNodeDenied = "You can not renew an active node. APIHub are not supporting this feature for now!";
        #endregion
