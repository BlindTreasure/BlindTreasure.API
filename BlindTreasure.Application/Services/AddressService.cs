...
public class AddressService : IAddressService
{
    ...
    public AddressService(IUnitOfWork unitOfWork, ICacheService cacheService, ILoggerService logger,
    ...
    public async Task<AddressDto> CreateAsync(CreateAddressDto dto)
    {
        ...
        var isFirstAddress = existingAddresses == null || !existingAddresses.Any();
        ...
        if (!isFirstAddress && dto.IsDefault)
        {
            ...
            var userAddresses =
                await _unitOfWork.Addresses.GetAllAsync(a => a.UserId == userId && a.IsDefault && !a.IsDeleted);
    ...
    public async Task<AddressDto> SetDefaultAsync(Guid id)
    {
        ...
        // Unset previous default addresses
        var userAddresses =
            await _unitOfWork.Addresses.GetAllAsync(a =>
                a.UserId == userId && a.IsDefault && !a.IsDeleted && a.Id != id);
        foreach (var addr in userAddresses)
        {
            addr.IsDefault = false;
            await _unitOfWork.Addresses.Update(addr);
