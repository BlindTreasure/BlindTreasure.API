...
public class SystemController : ControllerBase
{
    ...
    public async Task<IActionResult> SeedUserCartItems([FromQuery] Guid? userId = null)
    {
        try
        {
            ...
            var productCartItem = new CartItem
            {
                ...
                BlindBoxId = null,
                Quantity = 1,
                UnitPrice = randomProduct.RealSellingPrice,
                TotalPrice = randomProduct.RealSellingPrice * 1,
    ...
    public async Task<IActionResult> SeedUserOrder([FromQuery] Guid? userId = null)
    {
        try
        {
            ...
            foreach (var sellerGroup in productsBySeller)
            {
                ...
                var sellerTotalAmount = sellerProducts.Sum(p => p.RealSellingPrice);
                ...
                foreach (var product in sellerProducts)
                {
                    ...
                    var orderDetail = new OrderDetail
                    {
                        ...
                        TotalPrice = product.RealSellingPrice,
                        DetailDiscountPromotion = 0,
                        FinalDetailPrice = product.RealSellingPrice,
    ...
    private async Task SeedBlindBoxes()
    {
        ...
        // Lấy category Popmart
        var category = await _context.Categories
            .FirstOrDefaultAsync(c => !c.IsDeleted && c.Name == "PopMart");

        if (category == null)
        {
            _logger.Warn("[SeedBlindBoxes] Không tìm thấy category Popmart để tạo blind box.");
            return;
        }

        // Tạo 6 sản phẩm thuộc category Popmart
        ...
        var blindBox = new BlindBox
        {
            ...
            ImageUrl = "https://product.hstatic.net/200000943189/product/nqd_831b5c4e609c43d691c870ceeda5ce68.png",
            ReleaseDate = now,
            CreatedAt = now
        };
        ...
        _logger.Success("[SeedBlindBoxes] Đã seed blind box cho category Popmart thành công.");
    }
    ...
    private async Task SmiskiBlindBoxes()
    {
        ...
        var blindBoxProducts = new List<Product>
        {
            new()
            {
                ...
                SellerId = seller.Id,
                RealSellingPrice = 280000, TotalStockQuantity = 50, Status = ProductStatus.Active, CreatedAt = now,
            ...
            new()
            {
                ...
                CategoryId = smiskiCategory.Id,
                SellerId = seller.Id,
                RealSellingPrice = 500000, TotalStockQuantity = 20, Status = ProductStatus.Active, CreatedAt = now,
        ...
        switch (sellerEmail)
        {
            case "smiskiofficial@gmail.com":
                seller = new Seller
                {
                    ...
                    CompanyName = "Smiski Official Company Tokyo",
                    TaxId = "123456789",
            ...
            default:
                seller = new Seller
                {
                    ...
                    CompanyName = "Blind Treasure Distribution Company",
                    TaxId = "987654321",
