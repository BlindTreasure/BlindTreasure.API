const InitFunction = () => {
  ...
  searchDiv.style.gap = "12px";
  searchDiv.style.margin = "16px 0";
  ...
  tagFilterLabel.style.fontSize = "16px";
  ...
  allCheckboxDiv.innerHTML = `
    <label style="display: flex; align-items: center; font-weight: 500;">
      <input type="checkbox" value="__all__" checked style="margin-right: 8px;">All
    </label>
  `;
