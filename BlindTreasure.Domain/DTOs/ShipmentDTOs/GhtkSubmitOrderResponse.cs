...
public class GhtkSubmitOrderResponse
{
    ...
    [JsonPropertyName("order")] public SubmitOrderResponseOrder? Order { get; set; }
...
public class SubmitOrderResponseOrder
{
    ...
    [JsonPropertyName("insurance_fee")] public double? InsuranceFee { get; set; }

    [JsonPropertyName("tracking_id")] public int? TrackingId { get; set; } = default!;
    ...
    [JsonPropertyName("products")] public object[] Products { get; set; } = Array.Empty<object>();
