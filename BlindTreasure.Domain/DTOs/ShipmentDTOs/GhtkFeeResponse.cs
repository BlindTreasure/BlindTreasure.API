...
public class GhtkFeeResponse
{
    ...
    [JsonPropertyName("fee")] public GhtkFeeInfo? Fee { get; set; } = null!;
...
public class GhtkFeeInfo
{
    ...
    [JsonPropertyName("delivery_type")] public string DeliveryType { get; set; } = default!;

    [JsonPropertyName("a")] public int A { get; set; }

    [JsonPropertyName("dt")] public string Dt { get; set; } = default!;

    [JsonPropertyName("extFees")] public List<GhtkExtraFee> ExtFees { get; set; } = new();
