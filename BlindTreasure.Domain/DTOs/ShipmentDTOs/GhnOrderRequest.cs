...
{
    [DefaultValue(2)] public int PaymentTypeId { get; set; } = 2;

    [DefaultValue("cai nay de test ne")] public string? Note { get; set; }

    [DefaultValue("CHOXEMHANGKHONGTHU")] public string RequiredNote { get; set; } = "CHOXEMHANGKHONGTHU";
    ...
    [DefaultValue(0)] public int CodAmount { get; set; } = 0;
    ...
    [DefaultValue(0)] public int InsuranceValue { get; set; } = 0;

    [DefaultValue(2)] public int ServiceTypeId { get; set; } = 2;
