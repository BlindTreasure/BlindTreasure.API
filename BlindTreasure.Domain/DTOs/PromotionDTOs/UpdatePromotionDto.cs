...
namespace BlindTreasure.Domain.DTOs.PromotionDTOs
{
    public class UpdatePromotionDto
    {
        ...
        public DateTime? StartDate { get; set; } = DateTime.SpecifyKind(DateTime.Parse("2000-01-01T00:00:00Z"), DateTimeKind.Utc);

        [DefaultValue(typeof(DateTime), "2100-01-01T00:00:00Z")]
        public DateTime? EndDate { get; set; } = DateTime.SpecifyKind(DateTime.Parse("2100-01-01T00:00:00Z"), DateTimeKind.Utc);

        [DefaultValue(100)]
        public int? UsageLimit { get; set; } = 100;

        [DefaultValue(2)]
        public int? MaxUsagePerUser { get; set; } = 2;
    }
}
