        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailVerifyTokenExpires = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ResetPasswordToken = table.Column<string>(type: "text", nullable: false),
                    ResetPasswordExpires = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ...
                    PendingEmailVerifyExpires = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uuid", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Deposits_Users_ReleasedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VerificationRequestId = table.Column<Guid>(type: "uuid", nullable: true),
                    Status = table.Column<string>(type: "text", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sellers_Deposits_DepositId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Sellers_VerificationRequests_VerificationRequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Deposits_ReleasedBy",
                table: "Deposits",
                column: "ReleasedBy");

            migrationBuilder.CreateIndex(
                name: "IX_Deposits_SellerId",
                table: "Deposits",
                column: "SellerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sellers_VerificationRequestId",
                table: "Sellers",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Deposits_Sellers_SellerId",
                table: "Deposits",
                column: "SellerId",
                principalTable: "Sellers",
                principalColumn: "Id",
