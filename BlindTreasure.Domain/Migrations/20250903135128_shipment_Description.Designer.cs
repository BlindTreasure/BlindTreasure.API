...
namespace BlindTreasure.Domain.Migrations
{
    ...
    [Migration("20250903135128_shipment_Description")]
    partial class shipment_Description
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlindTreasure.Domain.Entities.GroupPaymentSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("GroupPaymentSessions");
                });
            ...
            modelBuilder.Entity("BlindTreasure.Domain.Entities.OrderDetailInventoryItemShipmentLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int?>("ValueStatusType")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("OrderDetailInventoryItemLogs");
                });
            ...
            modelBuilder.Entity("BlindTreasure.Domain.Entities.PayoutLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BlindTreasure.Domain.Entities.Product", b =>
                {
                    ...
                    b.Property<decimal>("RealSellingPrice")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("BlindTreasure.Domain.Enums.PayoutDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("PayoutDetails", (string)null);
                });
            ...
            modelBuilder.Entity("BlindTreasure.Domain.Entities.PayoutLog", b =>
                {
                    ...
                    b.HasOne("BlindTreasure.Domain.Entities.User", "TriggeredByUser")
                        .WithMany()
